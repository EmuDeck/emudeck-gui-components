  ...
  return (
    <Main>
      ...
      <div className="cards cards--mini">
        {branch != 'main' && (
          <Card
            css={cloudSync === 'Emudeck-cloud2' && 'is-selected'}
            onClick={() => onClick('Emudeck-cloud2')}
          >
            <svg
              width="56"
              height="56"
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stopColor="#99A3FF"></stop>
                  <stop offset="1" stopColor="#F6A2D8"></stop>
                </linearGradient>
                <linearGradient
