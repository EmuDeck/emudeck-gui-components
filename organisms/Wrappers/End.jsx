          ...
          {system !== 'win32' && (
            <Card css="is-selected">
              <div className="container--grid">
                ...
                <p className="lead">
                  Please check that all your emulators has been installed. If an
                  emulator or tool failed to install, run a
              ...
              <div className="container--grid">
                <div data-col-sm="7">
                  ...
                  <p className="lead">
                    ...
                    <br />
                    Make sure your handheld is on GamePad mode at all times, not
                    on Desktop or Auto.
                    <br />
                    <strong>
                      If you want to use other Frontends like Playnite you will
                      need to activate Steam Input on the Desktop as shown on
                      the video and keep Steam open in the background at all
                      times.
                    </strong>
                  </p>
                </div>
